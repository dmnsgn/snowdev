...
parser
  ...
  .options({
    ...
    minify: {
      group: "Input/meta options:",
      type: "boolean",
      describe: `Minify the code generated by build command.`,
      defaultDescription: `NODE_ENV === "production"`,
    },
    targets: {
      group: "Input/meta options:",
      type: "string",
      describe: `Browserslist targets used by build command.`,
      defaultDescription: `defaults and fully supports es6-module`,
    },
    updateVersions: {
      group: "Input/meta options:",
      type: "boolean",
